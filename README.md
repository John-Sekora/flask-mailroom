...
I installed heroku and pipenv. At first it let me sign in and even performed an update through "create". There was an issue, wish I could recall.
So I reinstalled it serveral times because the software offered several install options, but then I only got these messages.
I tried using Git Bash, Command Line, and Ubuntu. It took a lot of time away from finishing the assignments and I decided to move on.
